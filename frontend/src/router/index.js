...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'market/data', name: 'MarketDataCenter', component: () => import('../views/market/MarketDataCenter.vue') },
      ...
      { path: 'ml', name: 'MachineLearningLab', component: () => import('../views/ml/MachineLearningLab.vue') },
